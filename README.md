...
! [SSN] (https://github.com/bernardbenson/sunspot-timeseries/blob/master/final_val_ssn.png "SSN Forecast")

### Total Sunspot Area Forecast
! [TSA] (https://github.com/bernardbenson/sunspot-timeseries/blob/master/final_val_tsa.png "TSA Forecast")
